...
Install [Android Studio](https://developer.android.com/studio) (latest version that includes Java 21)

- Set environment variable `JAVA_HOME=/Applications/Android Studio.app/Contents/jbr/Contents/Home` to use the Java 21 version shipped with Android Studio
