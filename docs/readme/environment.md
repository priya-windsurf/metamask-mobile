...
- Set environment variable `JAVA_HOME=/Applications/Android Studio.app/Contents/jbr/Contents/Home` to use the Java 21 version shipped with Android Studio (Hedgehog 2023.1.1 or later)
